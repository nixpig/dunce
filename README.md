[![Workflow Status](https://github.com/nixpig/dunce/actions/workflows/general.yml/badge.svg?branch=main)](https://github.com/nixpig/dunce/actions/workflows/validate.yml?query=branch%3Amain)
